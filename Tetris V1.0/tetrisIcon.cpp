...
TetrisIcon::TetrisIcon(char* name)
{
	_name = name;
}
...
void TetrisIcon::createIcon(float start_pos_x, float start_pos_y, int x, int y)
{	
	_name = "board.png";
	...
	textureLoad();
	initSprite();
	_sprIcon->SetColor(0xbbDDDDDD);
	
}
void TetrisIcon::createIconMargin(float start_pos_x, float start_pos_y, int x, int y)
{	
	_name = "b.png";
	_start_pos_x=start_pos_x;
_start_pos_y=start_pos_y;
